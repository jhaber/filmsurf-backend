...
exports.test = function() {
    ...
    keepScraping(lastRun, 1).then(function() {
        fs.writeFileSync(__dirname + '/../lib/ebert-db.json', JSON.stringify(DB), 'utf8');
    });
};

function keepScraping(lastRun, page) {
    return scrapePage(lastRun, page).then(function(shouldContinue) {
        if (shouldContinue) {
            return keepScraping(lastRun, page + 1);
        } else {
            return Q.resolve();
        }
    });
...
function scrapePage(lastRun, page) {
